    ...
    <div className="my-64">
      ...
      <div ref={ref} className="relative w-[75%] mx-auto lg:w-[90%] md:w-full">
        ...
        <ul className="w-full flex flex-col items-start justify-between ml-4">
          <Details
            type="Msc in Human Computer Interaction"
            time="2023-2025"
            place="Drexel University"
            info="Relevant courses included Human Computer Interaction, UX Research Methods, and Human AI Interaction"
          />

          <Details
            type="Bachelor of Science in Computer Science"
            time="2018-2022"
            place="University of Technology, Jamaica"
