    ...
    >
      ...
      <div className="w-full flex justify-between items-center lg:hidden">
        <nav className="flex items-center justify-center">
          ...
          <CustomLink className="mx-4" href="/projects" title="Apps" />
          <CustomLink className="ml-4" href="/papers" title="Designs" />
      ...
      "
        >
          ...
          target={"_blank"}
          className="w-6 mr-3"
          href="https://twitter.com/turnedouttfine"
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.9 }}
        ...
        >
          ...
          <motion.a
            target={"https://github.com/McKiba"}
            className="w-6 mx-3"
            href="https://github.com/McKiba"
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
          ...
          <motion.a
            target={"_blank"}
            className="w-6 mx-3"
            href="https://www.linkedin.com/in/mckiba/"
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
      ...
      "
          ...
          href="https://twitter.com/turnedouttfinel"
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.9 }}
          aria-label="Checkout my twitter profile"
        >
